 ...
 */
var getGraphqlResponse = function (payload) { return __awaiter(void 0, void 0, void 0, function () {
    var response, data, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 3, , 4]);
                return [4 /*yield*/, (0, cross_fetch_1.default)("https://www.instagram.com/graphql/query", {
                        method: "POST",
                        body: payload,
                        headers: {
            ...
            case 3:
                error_1 = _a.sent();
                console.error("Error fetching Instagram data:", error_1);
                return [3 /*break*/, 4];
            case 4: return [2 /*return*/];
        }
    });
}); };
exports.default = getGraphqlResponse;
